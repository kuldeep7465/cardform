...
<form action="" method="post"> 
  ...
  <div class="mb-3">
    ...
    <input type="password" name="Re-Pass"  class="form-control" id="exampleInputPassword1">
  </div>
...
if ($pass==$Re_pass) {
    # code...
    $sql="INSERT INTO `loginsystem` ( `username`, `pass`, `Re-pass`) VALUES ( '$username', '$pass', '$Re_pass')";
